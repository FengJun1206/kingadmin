"""
Django settings for Test_Kingadmin project.
...
SECRET_KEY = 'on_ijubx2wkm&qd8*xwv36d(-5dve6k0&vo(k*l_gy+y-omduy'
...
# 没有登录的页面将被重定向到 http://127.0.0.1:8000/login/?next=/crm/dashboard/
